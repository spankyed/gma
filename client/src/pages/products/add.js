...
export default {
  ...
  view: ({state, actions}) =>_=> {
    ...
    return (
      <div onclick={actions.toggleAdd} class="opac absolute w-full h-full top-0 left-0 pt-16 xl:pt-20 justify-center" style="z-index:9000;">
        <div class="w-full flex mx-auto text-gray-800 leading-normal max-w-6xl" >
          <form  class="w-full relative" name="add" id="add" action="/upload" method="post" enctype="multipart/form-data">
            <div onclick={e=>e.stopPropagation()} class="static px-8 pt-6 pb-8 mb-4 bg-gray-900 border border-gray-800 rounded shadow md:flex">
              ...
              <div class="w-1/2 mx-auto mb-6 md:mb-0 bg-pink-700">
                <img id="preview" src={state.src} alt="Product Image" width="300" height="300" class="max-w-full mx-auto"/>
              </div>
                ...
                <div class="flex px-3 mb-6">
                  ...
                  <div class="w-2/3 flex text-gray-300 relative">
                    <div class="absolute bottom-0 w-full">
                      ...
                      <div class="w-1/2 px-2 text-center align-baseline text-gray-100">
